...
@WebServlet("/AdminGoodsAddServlet")
...
if(isMultipart) {		
      ...
      //upload.setSizeMax(1024*1024*10); //10M
		...
		dto.setGoods_Image1(dto_info.get(0));
		dto.setGoods_Image2(dto_info.get(1));
		dto.setGoods_Code(dto_info.get(2));
		...
		int n = service.adminGoodsInsert(dto);
